                    ...
                    <form action="{{url('account/create/acc/chart/stored')}}" method="post">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('typeaccountcode',$typeacc,null,['class'=>'edit-form-control','placeholder'=>'Please choose one...']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" id="description" class="edit-form-control">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('sign',['dr'=>'Dr','cr'=>'Cr'],null,['class'=>'edit-form-control','placeholder'=>'Please choose one...']) !!}
                                @if($errors->has('sign'))
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('valueSign',['-1'=>'-1','1'=>'+1'],null,['class'=>'edit-form-control','placeholder'=>'Please choose one...']) !!}
