                        ...
                        <div class="content" style="margin-top: 20px;">
                            <table border="0px" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="text-align: center;font-size: 12px;font-family: 'Khmer OS System';"></div>
                                    </td>
                                    <td>
                            ...
                            <div style="margin-top: 10px;margin-bottom: 5px;font-size: 12px;font-family: 'Khmer OS System';">Reported By: <b>{{Auth::user()->username}}</b></div>
                            @if($import->count())
                            <table width="1600px" class="table-responsive" border="1px" style="border: 1px solid gray; border-collapse: collapse;" cellpadding="5px" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center;font-size: 11px;font-weight: bold; padding: 2px 5px; font-family: 'Arial';">Supplier Name</th>
                                ...
                                @foreach($import as $in)
                                    <tr>
                                        ...
                                        <td style="padding-left: 3px; font-size: 10px;height: 20px; font-family: 'Khmer OS System';">{{$in->supplier->companyEnName}}</td>
                                        <td style="padding-left: 3px;font-size: 10px;height: 20px; font-family: 'Arial';">{{$in->supplier->personalName}}</td>
                                        @foreach($products as $pro)
                                            <?php
                                            $product_id =0;
                                            $qty =0;
                                            $histories = DB::table('histories')->where([['import_id','=',$in->id],['product_id','=',$pro->id],])->get();
                                            foreach ($histories as $his) {
                                                $product_id = $his->product_id;
                                                $qty = $his->qty;
                                            }
                                            ?>
                            ...
                            @else
                                <h4 style="background-color: #dddddd; padding: 5px 15px; text-align: center;border-radius: 2px;">No Found Record</h4>
                            @endif
                        </div>
