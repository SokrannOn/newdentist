...
//            'brand_code.required'       =>'The brand code required...',
          ...
          //dd(Session::get('Batch'));
        if(Session::get('Batch')!=null){
...
///     Session::forget('Transition');  Delete session
    ...
    public function BanlanceSearch(Request $request){
        ...
        $transaction = Transection::whereIn('typeaccount_id',[1,2,3,4,5,6,7])->whereBetween('transectionDate',[$startDate,$endDate])->OrderBy('chartaccount_id','desc')->get();
